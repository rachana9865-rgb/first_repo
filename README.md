...
2. Stages any changes made, using the , '+' in source control next t-Stage files - you've made changes and you want to POSSIBLY save them permanently as a version.
...
- Stage files -you've made changes and you want to POSSIBLY save the permanently as a version.
